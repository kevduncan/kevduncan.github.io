...
$(document).ready(function () {
	...
	var App = {
		...
		bindEvents: function () {
			...
			$(".carousel-inner").on(
				"mouseenter",
				".carousel-row-container .overlay",
				Utils.showDescription
			);
			$(".carousel-inner").on(
				"mouseleave",
				".carousel-row-container .overlay",
				Utils.hideDescription
			);
			$("#download-res").on("click", function (e) {
				window.open(
					"https://docs.google.com/document/d/1JStCrhjqigr5wUVTwtIKbRZY58ohFzB5eQz5CWasXUk/edit?usp=sharing",
					"_blank",
					"fullscreen=yes"
				);
			});
	...
	window.onload = function () {
		...
		css.type = "text/css";
		css.innerHTML =
			".typewrite > .wrap { border-right: 0.08em solid #fff; animation: blink-caret 1s steps(1) infinite;}";
